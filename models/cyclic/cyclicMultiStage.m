% Implementation of Multistage NMPC for cyclic model
...
% screnario tree NMPC dedicated for cyclic process
[~, xms, ums, obj, runtime] = sNmpcCyclic(@optProblem, @system, mpciterations, N, T, tmeasure, xmeasure, u0, scr);

keyboard;

save sNmpcCyclic.mat xms ums;
