%MULTISTAGENMPCDISTCOLA Summary of this function goes here
%
% Multistage NMPC for CSTR + Distillation Column A.
% The time varying parameter is price.
%
% 
% [OUTPUTARGS] = MULTISTAGENMPCDISTCOLA(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2018/12/27 23:35:55 $	$Revision: 0.1 $
% Copyright: Process Control Group - NTNU Trondheim 2018



global N scenario nx;
nx = 84;
...
[~, xmIdealAs, umIdealAs, objIdeal, runtimeIdeal] = sNmpcDistColA(@optProblem, @system, mpciterations, N, T, tmeasure, xmeasure, u0, scr);
 
%save idealMs21062019.mat;
%save idealMs04082019.mat;
keyboard;
