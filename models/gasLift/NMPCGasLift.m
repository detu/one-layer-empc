...
%save iNmpc.mat xmeasureAll uAll runtime;
...
[~, xmeasureAll_pf, uAll_pf, obj_pf, optRes_pf, params_pf, runtime_pf, Eta_pf] = OutputPfNmpc(@optProblem, @system, mpciterations, N, T, tmeasure, xmeasure, u0, param);
%save pfNmpc.mat xmeasureAll_pf uAll_pf runtime_pf Eta_pf;
