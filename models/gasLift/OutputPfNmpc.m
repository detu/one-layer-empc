function [Tall, xmeasureAll, uAll, ObjVal, primalPF, params, runtime, Eta] = OutputPfNmpc(optProblem, system, mpciterations, N, T, tmeasure, xmeasure, u0, paramModel, varargin)
...
while(mpciter <= mpciterations)
    ...
    [primalPF, ~, elapsedqp, EtaData] = jpredictorLicq(@(p,paramModel)gasLiftRiser(p,paramModel), p_init, p_final, xstart, ystart, delta_t, lb_init, ub_init, 0, N, paramModel);
